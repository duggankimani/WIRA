...
public class RequestInfo implements Serializable{
    ...
    @OneToMany( mappedBy="requestInfo") //cascade= CascadeType.ALL,
    ...
    public String toString() {
        return "RequestInfo{" + "id=" + id + ", time=" + time + ", status=" + status + ", commandName=" + commandName + ", message=" + message + ", messageKey=" + messageKey + ", requestData=" + requestData + ", responseData=" + responseData + ", error=" + errorInfo + '}';
    }
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + (this.messageKey != null ? this.messageKey.hashCode() : 0);
