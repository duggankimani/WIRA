...
public class TestMvel {
	...
	public void scriptMvel() throws FileNotFoundException, IOException{
		...
		String script = "setValue('poNumber',new com.duggan.workflow.shared.model.StringValue(null,'poNumber',"
				+ "com.duggan.workflow.server.db.DB.getSingleResult('select "
				+ "concat(id,subject) from localdocument where subject='+subject)));"
