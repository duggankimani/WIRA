...
public class TestData {
  ...
  static String[] invoiceRanges = new String[]{"0-30","30-60","60-90","90 +Days"};
  public static List<Data> getInvoiceData(int size, double min, double scale) {
	    List<Data> data = new ArrayList<Data>();
	    for (int i = 0; i < size; i++) {
	      data.add(new Data(invoiceRanges[i % invoiceRanges.length], Math.floor(Math.max(Math.random() * scale, min))*1000, Math.floor(Math.max(Math.random() * scale, min)),
  ...
  public static List<Data> getData(int size, double min, double scale) {
  	...
  	static String [] companies = new String[]{
  		...
  		"Cooper Motor Corporation, automotive",
  		"Del Monte Kenya",
  		...
  		"Heritage A.I.I Insurance Company Limited",
