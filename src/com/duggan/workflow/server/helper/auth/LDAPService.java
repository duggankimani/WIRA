...
public class LDAPService implements InitializingBean, DisposableBean, Lifecycle, ApplicationContextAware {
    ...
    public LDAPService(String root, String ldifs) throws Exception {
