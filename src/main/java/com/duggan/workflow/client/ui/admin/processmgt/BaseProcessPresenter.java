...
public class BaseProcessPresenter extends Presenter<BaseProcessPresenter.MyView, BaseProcessPresenter.MyProxy>  {
    ...
    public void prepareFromRequest(PlaceRequest request) {
    	...
    	placeManager.revealPlace(new PlaceRequest.Builder().nameToken(NameTokens.processes).build());
    }
