...
import com.duggan.workflow.shared.events.EditCatalogDataEvent.EditCatalogDataHandler;
import com.duggan.workflow.shared.events.EditCatalogSchemaEvent;
import com.duggan.workflow.shared.events.EditCatalogSchemaEvent.EditCatalogSchemaHandler;
...
public class DataTablePresenter
	...
	protected void showPopup(Catalog catalog) {
		...
		AppManager.showPopUp((catalog==null || catalog.getId()==null)?
				"Create Table":"Edit Table", view, "create-data-table-popup",
				new OptionControl() {
