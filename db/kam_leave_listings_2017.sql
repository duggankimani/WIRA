create or replace view kam_leave_listings_2017 as 
(
select l.applicant, 
...
where l.applicationdate >= to_date('2017-01-01', 'YYYY-mm-dd') and l.applicationdate <= to_date('2017-12-30', 'YYYY-mm-dd') 
);
